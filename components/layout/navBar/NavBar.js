...
import MenuAuthed from "../../auth/MenuAuthed";
...
function NavBar() {
  ...
  return (
    <Box bg="#ffff99" w="100%" color="#5f5338" fontWeight="bold">
      <Flex margin="auto" maxW="1050px">
        ...
        <Box w="60%" margin="auto" display={{ base: "none", md: "block" }}>
                ...
                >
                  <Link href={tab.path}>
                    <Center
                      ...
                      className={
                        stateNav === tab.name ? "navActive" : "navItem"
                      }
                    >
                      {tab.name}
                    </Center>
        ...
        <Box w="20%" margin="auto" display={{ base: "none", md: "block" }}>
          {isLogin ? <Authed /> : <Auth />}
        </Box>
        <Box w="80%" margin="auto" display={{ base: "block", md: "none" }}>
          <Flex>
            <Box w="80%" p={1} textDecoration="underline overline">
              <Text fontSize={{ base: "sm", sm: "lg" }}>
                MANG THỰC PHẨM SẠCH
              </Text>
              <Text fontSize={{ base: "sm", sm: "lg" }} textAlign="right">
